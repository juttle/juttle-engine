...
var JobManager = Base.extend({
    ...
    run_program: function(options) {
        ...
        // If wait_for_end is true, create an ImmediateJuttleJob
        // for the job and the promise we return will resolve only
        // when the program is complete. Otheriwse, create a
        // WebsocketJuttleJob and the promise we return will resolve
        ...
        // Return a promise. If wait_for_end is true, the promise
        // resolves when the job is complete, with the complete output
        // of the program. Otherwise, the promise resolves when the
        // job has started, with the pid and job id.
